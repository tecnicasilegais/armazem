...
/**
 * Classe responsavel pela leitura e persistencia de dados do arquivo de Veiculos
 */
public class PersistenciaVeiculos 
{
    ...
    /**
     * Metodo que passa a lista de veiculos para um HashMap
     * -utilizado para impedir repeticoes na base de dados
